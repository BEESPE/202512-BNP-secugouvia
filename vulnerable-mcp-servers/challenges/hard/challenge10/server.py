...
mcp = FastMCP("Challenge 10")

# Create directories for the challenge
os.makedirs("/tmp/challenge10/data", exist_ok=True)
os.makedirs("/tmp/challenge10/config", exist_ok=True)
os.makedirs("/tmp/challenge10/logs", exist_ok=True)

# Create a sensitive configuration file
with open("/tmp/challenge10/config/system.conf", "w") as f:
    f.write("""
[System]
...
# Add a  tool that executes commands
