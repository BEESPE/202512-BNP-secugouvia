...
mcp = FastMCP("Challenge 8")

# Create a directory for sensitive files
os.makedirs("/tmp/challenge8/sensitive", exist_ok=True)

# Create a sensitive file with confidential information
with open("/tmp/challenge8/sensitive/credentials.txt", "w") as f:
    f.write("""
...
def execute_python_code(code: str) -> str:
    ...
    try:
        ...
        result = subprocess.check_output(
            [sys.executable, temp_file_path], stderr=subprocess.STDOUT)
